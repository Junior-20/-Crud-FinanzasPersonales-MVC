...
namespace FinanzasPersonales_G_.Controllers
{
    public class PROCESO_CORTEController : Controller
    {
        ...
        {
            return View(db.PROCESO_CORTE.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "ID,Ano,Mes,Fecha_Corte,Balance_Inicial,Total_ingreso,Total_Egreso,Balance_corte")] PROCESO_CORTE pROCESO_CORTE)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Ano,Mes,Fecha_Corte,Balance_Inicial,Total_ingreso,Total_Egreso,Balance_corte")] PROCESO_CORTE pROCESO_CORTE)
        {
            if (ModelState.IsValid)
            {
